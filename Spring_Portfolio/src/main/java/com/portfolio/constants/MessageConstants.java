...
public class MessageConstants {
    ...
    public static final String DATE_FORMAT_ERROR_RANGE = "服務生效日期(起) 不可晚於服務生效(迄) 日期",
    						  BANK_CODE_FORMAT_ERROR = "信託機構代碼只能包含英文大小寫、數字、減號、底線",
                              BANK_NAME_LENGTH_ERROR = "機構名稱最多40個字元",
                              SEARCH_STATUS_ERROR = "狀態選擇錯誤",
                              BANK_MST_NOT_FOUND_ERROR = "此筆信託機構主檔不存在,",
                              BANK_TEMP_NOT_FOUND_ERROR = "此筆信託機構暫存檔不存在,",
                              BANK_SELECT_NOT_FOUND_ERROR = "請選擇正確的信託機構代號",
                              ...
                              NOTIFY_MEMBER_TEMP_NOT_FOUND_ERROR = "此筆群組人員暫存檔不存在",
                          	  ...
                          	  BANK_DELETE_ERROR="無法刪除，信託機構代碼已關聯至 License, 信託機構代碼 :",
                              ...
                              // JWE 相關
                          	  JWEKEY_SEARCH_INPUT_ERROR_1 = "信託機構代碼只能包含英文大小寫、數字、減號、底線",
                              ...
                              TXN_SEARCH_BANK_ID_ERROR = "信託機構代碼長度不可超過10",
